				...
				<div class="mdc-dialog__surface">
					...
					<section id="rename-dialog-content" class="mdc-dialog__content">
						<div class="mdc-text-field" id="password-field" style="width: 100%; margin-bottom: 8px">
							<input type="password" id="password-input" class="mdc-text-field__input" required v-model="password">
							<label class="mdc-floating-label" for="password-input">Password</label>
							<div class="mdc-line-ripple"></div>
						</div>
						<div class="mdc-text-field" id="password-confirm-field" style="width: 100%">
							<input type="password" id="password-confirm-input" class="mdc-text-field__input" required v-model="passwordConfirm">
							<label class="mdc-floating-label" for="password-confirm-input">Confirm Password</label>
							<div class="mdc-line-ripple"></div>
						</div>
					</section>
					<footer class="mdc-dialog__actions">
						<button class="mdc-button mdc-dialog__footer__button mdc-dialog__footer__button--cancel" @click="closePasswordDialog">Cancel</button>
						<button class="mdc-button mdc-dialog__footer__button mdc-dialog__footer__button--accept mdc-dialog__action" @click="closePasswordDialog">Change Password</button>
					</footer>
				</div>
			</div>
